...
import { FaArrowCircleRight, FaArrowRight, FaHeart, FaLocationArrow, FaMap, FaPhone, FaUser } from "react-icons/fa";
...
<g>
                ...
                >
                  <div>
                    ...
                    >
                      <div className="wsus__single_category_2">
                        <span>
                        <svg width="50px" height="50px" viewBox="0 0 60.601 60.601" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:cc="http://creativecommons.org/ns#" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <metadata>
    <rdf:rdf>
      <cc:work rdf:about>
  ...
  <path d="m7.7855 56.032c-1.7762 0-3.2162-1.44-3.2162-3.2162v-45.03c0-1.7762 1.44-3.2162 3.2162-3.2162h45.031c1.775 0 3.215 1.44 3.215 3.2162v45.03c0 1.7762-1.44 3.2162-3.215 3.2162h-45.031z" style={{"fill":"#ffffff","stroke-width":".60625","stroke":"#000"}} />
                ...
                >
                  <div>
                    ...
                    >
                      <div className="wsus__single_category_2">
                        <span>
                        <svg fill="#000000" height="50px" width="50px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xmlSpace="preserve">
  <g>
    <g>
      <g>
          ...
          <div className="row">
            ...
            <div className="col-xl-6 m-auto">
              <div className="wsus__about_us_text">
                ...
                <a href=" ">
                  Read More
                  <FaArrowRightToCity style={{margin:"5px"}} className="fal fa-long-arrow-right" aria-hidden="true" />
                </a>
              </div>
            </div>
          </div>
  ...
  <div className="featured_listing_item_2">
    <div className="featured_listing_item_img">
      ...
      <span className="love"><a data-bs-toggle="modal" data-bs-target="#exampleModal" ><FaHeart className="fas fa-heart" aria-hidden="true" /></a></span>
     
    </div>
    <div className="featured_listing_item_text">
      <span className="author">
        <img src="./DirList - Home Page_files/admin.jpg" alt="User" className="img-fluid w-100" />
      </span>
     
      <a className="title" href="">{product.name}</a>
      <ul>
        <li>
          <FaPhone style={{margin:"5px"}} className="fas fa-phone-alt" aria-hidden="true" /> Call :
          {product.contact}
        </li>
        <li>
          <FaLocationArrow  style={{margin:"5px"}}  className="fas fa-map-marker-alt" aria-hidden="true" /> {product.location}
        </li>
        <li>
          <FaUser  style={{margin:"5px"}}  className="fas fa-calendar-alt" aria-hidden="true" />
          {product.authorname}
        </li>
      </ul>
    </div>
  ...
  <section id="wsus__map_popup">
    <div className="modal fade" id="listngPopUp-72" tabIndex={-1} aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div className="modal-dialog">
        <div className="modal-content">
          <button type="button" className="btn-close popup_close" data-bs-dismiss="modal" aria-label="Close">
            ...
            <div className="row">
              <div className="col-12 col-xl-12 col-md-12">
                <div className="map_popup_content">
                  <img src="./DirList - Home Page_files/listing-thumb-2024-07-08-09-27-26-6675.jpg" alt="images" className="img-fluid w-100" />
                  <div className="map_popup_text">
                    ...
                    <span className="red"><i className="far fa-check" aria-hidden="true" />
                      Verified</span>
                    <h5>Prime Realty</h5>
                    <a className="call" href="callto:(212) 555-1234"><i className="fal fa-phone-alt" aria-hidden="true" />
                      (212) 555-1234</a>
                    <a className="mail" href="mailto:info@primerealtyexample.com"><i className="fal fa-envelope" aria-hidden="true" />
                      info@primerealtyexample.com</a>
                    <p>
                      Residential and commercial properties in prime
                      locations.
                    </p>
                    <a className="read_btn" href="https://demo.websolutionus.com/dirlist/listing/prime-realty">Read More</a>
                  </div>
                </div>
              </div>
              <div className="col-12 col-xl-12 col-md-12">
                <div className="map_popup_content_map">
                  <iframe src="./DirList - Home Page_files/embed.html" width={600} height={450} style={{"border":"0"}} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
                </div>
              </div>
            </div>
          </div>
