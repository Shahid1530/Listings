...
<div>
 ...
 LOG IN POPUP END
  ...
  <footer className="footer_2">
    <div className="container">
      <div className="footer_2_subscription_bg" style={{"background":"url('https://c4.wallpaperflare.com/wallpaper/95/875/676/nature-landscape-reflection-lake-wallpaper-preview.jpg')"}}>
        <div className="row">
    ...
    <div className="footer_2_bg" style={{"background":"url('https://c4.wallpaperflare.com/wallpaper/95/875/676/nature-landscape-reflection-lake-wallpaper-preview.jpg')"}}>
